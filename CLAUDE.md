...
src/
  ...
  i18n/           index.ts (Proxy reativo `t`; dicionários pt.ts/en.ts/es.ts — 516 chaves; `setLangDict`+`LANGS`; `LanguageSelect` em TopNav/Sidebar/LoginPage)
...
- **1011 testes verdes (85 arquivos)**, build verde, smoke verde (Chromium headless: render, navegação, drill, painel coach).
